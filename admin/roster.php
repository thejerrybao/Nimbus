...
<body>
                            ...
                            <div class="panel panel-primary">    
                                ...
                                <div class="panel-body">
                                    <? function dateOrder($a, $b){
                                        ...
                                        $event_ids = $userdb->getUserEvents($_GET['id']);
                                        $events = array();
                                ...
                                <? $club = $userdb->getTotalHours("all") ?>

                                    <label>Service Hours:</label>
                                    <p style="display: inline; margin-right: 50px;"><?= $user['hours']['service_hours'] ?></p>
                                    <label>Club Total Service Hours:</label>
                                    <p style="display: inline; margin-right: 50px;"><? $club ?></p>
    ...
    <script type="text/javascript">
      function modalOpen(eventid) {
        $("#eventModal").load("/~circlek/admin/UserEventInfo.php?id="+eventid);
