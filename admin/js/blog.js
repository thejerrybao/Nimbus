...
$("#form-event-tags, #form-author, #form-add-event-attendees, #form-delete-event-attendees, #form-add-override-hours, #form-delete-override-hours, #form-delete-other-attendees").chosen({
