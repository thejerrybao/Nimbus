...
<head>
    ...
    <title>Project Nimbus - Tag Administration</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="tag-abbrev">Tag Abbreviation</th>
                                        <th id="tag-mrp?">MRP Tag?</th>
                                        <!--Change the style of tag-mrp in the css file-->
                                    </tr>
                                </thead>
                                <tbody>
                                <? foreach ($tags as $tag) { ?>
                                    <tr>
                                        ...
                                        <td><a href="tags.php?view=tag&id=<?= $tag['tag_id'] ?>"><?= $tag['abbrev'] ?></td>
                                        <td><a href="tags.php?view=tag&id=<?= $tag['tag_id'] ?>"><? if ($tag['mrp_tag'] == 1) ? "Yes" : "No"; ?></td>
                                    </tr>
                                <? } ?>
                                </tbody>
                            </table>
            ...
            <? case "mrpadd": ?>
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">MRP Information</h1>
                    </div>
                </div>
                    <h2>No Tag ID specified.</h2>
                <? if (empty($_GET['id'])) { ?>
                <? } else { $tag = $tagdb->getTag($_GET['id']); } ?>
                <? if ($tag) { ?>
                <div class="row">
                    <div class="col-lg-8">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <label>Tag Name:</label> <?= $committee['name'] ?><br />
